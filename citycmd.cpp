...
*
* 情况2: 获得金钱
*   - 获得: 10 + random(0, 智力 * 2) 金
*
* 情况3: 获得粮食
*   - 获得: 10 + random(0, 智力 * 2) 粮
*
* 成功因素:
* - 武将智力影响搜寻成功率和获得数量
* - 智力越高越容易找到武将/道具
...
1. 目标选择限制:
   - 不能劝降玩家君主 (o == g_PlayerKing)

2. 势力对比要求:
   - 己方城池数量必须大于目标势力的2倍
   - 通过 GetKingCitys() 检查城池数量

3. 智力检定:
   - 基础成功率 = 50 + (劝降者智力 - 目标智力)
   - 需要随机数 rand() % 100 小于成功率

4. 性格影响 (不同性格有不同成功率): 随机数值范围 0 ~ 100 小于以下数值:
   - 和平性格 (CHARACTER_PEACE): PERSUADE_PEACE
   - 正义性格 (CHARACTER_JUSTICE): PERSUADE_JUSTICE  
   - 奸诈性格 (CHARACTER_DUPLICITY): PERSUADE_DUPLICITY
   - 狂傲性格 (CHARACTER_CRAZY): PERSUADE_CRAZY
   - 鲁莽性格 (CHARACTER_RASH): PERSUADE_RASH
